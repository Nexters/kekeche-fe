...
export const Keywords = [
    ...
    { id: 10, name: '웃긴', colorClassname: 'bg-[#FFF6DA] text-[#E7B110]' },
    { id: 11, name: '쾌활한', colorClassname: 'bg-[#FFF6DA] text-[#E7B110]' },
    { id: 12, name: '사교적', colorClassname: 'bg-[#FFF6DA] text-[#E7B110]' },
    { id: 13, name: '활발한', colorClassname: 'bg-[#FFF6DA] text-[#E7B110]' },
    { id: 14, name: '긍정적', colorClassname: 'bg-[#FFF6DA] text-[#E7B110]' },
    { id: 15, name: '조용한', colorClassname: 'bg-[#F1FFDF] text-[#6DBD05]' },
    { id: 16, name: '지혜로운', colorClassname: 'bg-[#F1FFDF] text-[#6DBD05]' },
    { id: 17, name: '신중한', colorClassname: 'bg-[#F1FFDF] text-[#6DBD05]' },
    { id: 18, name: '꼼꼼한', colorClassname: 'bg-[#F1FFDF] text-[#6DBD05]' },
    { id: 19, name: '성실한', colorClassname: 'bg-[#F1FFDF] text-[#6DBD05]' },
