...
export default function CharacterCreateButton() {
    return (
        <Link
            ...
            className="grid h-[215px]  place-items-center  rounded-2xl bg-white shadow-[0px_8px_24px_rgba(149,157,165,0.15)] active:shadow-[inset_0px_1px_3px_0px_rgba(0,0,0,0.2)]"
        >
